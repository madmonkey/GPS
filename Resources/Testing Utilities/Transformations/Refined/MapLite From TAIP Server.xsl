...
<!--MapLite From TAIP Server.xsl (c) SunGard HTE Inc-->
		
<!--MAPLITE FROM TAIP (DECIMAL DEGREES) STYLESHEET STANDARD (SINCE CAD(s) ACCEPT ONLY DECIMAL DEGREES)--> 
				<xsl:output method = "xml" standalone ="yes"/> 
					...
					<GPSTransform>
							...
							<xsl:variable name="unitID" select="substring-before(substring-after(concat(.,';ID='),'ID='),';')"/>
